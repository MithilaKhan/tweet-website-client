...
const Navbar = () => {
  ...
  return (
    <header
      className={`bg-[#FFFFFF] shadow 

            sticky top-0  z-50 w-full transition-all duration-500 navbar-container 
    ${
      isScrolled
        ? "bg-white mt-0"
    ...
    `}
    >
      <nav className="container  h-[80px]  relative z-10 w-full ">
        <div className="flex justify-between items-center h-full w-full ">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link href={`/food/1`} className="hidden md:flex">
            ...
            <Link href={"/profile"} className=" flex items-center gap-2">
              <Image
                ...
                height={40}
                width={40}
                className=" h-[40px] w-fit rounded-full border-[2px] border-primary"
              />
              <p>Asad</p>
            </Link>
