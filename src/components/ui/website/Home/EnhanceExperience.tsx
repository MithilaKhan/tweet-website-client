...
const EnhanceExperience = () => {
    return ( 
        <div className='lg:pt-[38px] pb-[100px]'>
            <div  
                className="lg:h-[684px] h-auto flex items-center justify-center z-30 container relative"
                style={{
            ...
            >
                <div className="flex lg:flex-row flex-col-reverse items-center w-full">
                    {/* Left Column */}
                    <div className="space-y-2.5 lg:w-[56%] w-full px-4 lg:mb-0 mb-40">
                        ...
                        <p className="text-sm md:text-base text-[#5C5C5C] tracking-tight w-full lg:pb-6 pb-10">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-x-7 lg:gap-y-0 gap-y-4">
                ...
                <div className="text-center">
                  ...
                  <div className="text-white  lg:text-[20px] text-[18px] font-normal">Average Review</div>
                    ...
                    <div className="lg:w-[44%] w-full flex items-center justify-center lg:mb-0 mb-5">
                        <div className="relative lg:w-[343px] w-full lg:h-[614px] h-[400px]">
                            <img
                                src="/phone.svg"
