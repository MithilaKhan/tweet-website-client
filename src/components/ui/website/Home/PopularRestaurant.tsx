        ...
        <div>
          ...
          <div className="pb-[36px] container">
            <div className='flex items-center justify-between'>
              ...
              <button  onClick={() => router.push(`/restaurants`)} className=' border border-primary text-primary  px-8 rounded-lg h-[48px] hover:bg-primary hover:text-white font-medium'  > View All </button>
            </div>
          </div>  
