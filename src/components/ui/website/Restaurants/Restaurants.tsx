  ...
  return (
    <div className="container py-[50px]">
      <div className="grid grid-cols-12 gap-5">
        {/* Filter Sidebar */}
        <div
          className="sm:hidden lg:grid-cols-3   fixed inset-0 z-50 bg-black/50 transition-opacity duration-300"
          style={{ display: isFilterVisible ? "block" : "none" }}
          onClick={() => setIsFilterVisible(false)}
        ></div>
        <div
          className={`fixed z-10 top-32 left-0 lg:w-full lg:h-[450px] h-[550px]   w-3/4 bg-[#D86020] rounded-lg p-6 transition-transform duration-300
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  ...
                  >
                    ...
                    <Select.Option value="Most Popular">
                      Most Popular
                    </Select.Option>
                    <Select.Option value="Ratings">Ratings</Select.Option>
                    <Select.Option value="Delivery Fee">
                      Delivery Fee
                    </Select.Option>
                  </Select>
                </ConfigProvider>
